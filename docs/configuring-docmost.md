...
See the project's [documentation](https://docmost.com/docs/) to learn what The Lounge does and why it might be useful to you.
...
**Note**: hosting The Lounge under a subpath (by configuring the `docmost_path_prefix` variable) does not seem to be possible due to The Lounge's technical limitations.
...
See its [environment variables](https://docmost.com/docs/self-hosting/environment-variables) for a complete list of The Lounge's config options that you could put in `docmost_environment_variables_additional_variables`.
